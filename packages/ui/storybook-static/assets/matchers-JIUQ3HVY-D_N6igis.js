...
function t() {
  ...
  for (let [t, n] of Object.entries(m)) {
    for (let [t, r] of Object.entries(n))
      ((m[t] = { open: `\x1B[${r[0]}m`, close: `\x1B[${r[1]}m` }),
        (n[t] = m[t]),
        e.set(r[0], r[1]));
...
function a(e, t = 10, n = 10) {
  let r = 1e4,
    i;
  try {
    i = (0, Q.format)(e, { maxDepth: t, maxWidth: n, min: !0, plugins: me });
  } catch {
    i = (0, Q.format)(e, { callToJSON: !1, maxDepth: t, maxWidth: n, min: !0, plugins: me });
  }
...
function c(e, t = `received`, n = `expected`, r = {}) {
  ...
  return (
    ...
    c !== `` && ((f += $(`${p}.`) + c), (p = ``)),
    s && ((f += `${$(`${p}.`)}not`), (p = ``)),
    e.includes(`.`) ? (p += e) : ((f += $(`${p}.`) + e), (p = ``)),
    n === `` ? (p += `()`) : ((f += $(`${p}(`) + a(n)), u && (f += $(`, `) + d(u)), (p = `)`)),
    i !== `` && (p += ` // ${i}`),
    p !== `` && (f += $(p)),
    f
  );
      ...
      'node_modules/react-is/cjs/react-is.development.js'(e) {
        (function () {
          ...
          ((e.ContextConsumer = C),
            ...
            (e.isContextConsumer = z),
            (e.isContextProvider = B),
            (e.isElement = V),
            (e.isForwardRef = H),
            (e.isFragment = U),
            (e.isLazy = W),
