    ...
    var ed = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        OPEN_IN_EDITOR_RESPONSE: _d,
        PLAY_FUNCTION_THREW_EXCEPTION: xd,
        PRELOAD_ENTRIES: $d,
    ...
    function dn(e) {
      let t = e + 'CollectionProvider',
        ...
        o = (g) => {
          ...
          return n.createElement(l, { scope: h, itemMap: T, collectionRef: x }, R);
        };
      Object.assign(o, { displayName: t });
      let u = e + 'CollectionSlot',
        c = n.forwardRef((g, h) => {
          let { scope: R, children: x } = g,
            T = i(u, R),
      ...
      function S(g) {
        ...
        return n.useCallback(() => {
          ...
          if (!R) return [];
          let x = Array.from(R.querySelectorAll(`[${d}]`));
                ...
                onKeyDown: X(e.onKeyDown, (h) => {
                  ...
                  if (R !== void 0) {
                    ...
                    if (R === 'last') x.reverse();
                      ...
                      R === 'prev' && x.reverse();
                      let T = x.indexOf(h.currentTarget);
                      x = s.loop ? On(x, T + 1) : x.slice(T + 1);
                    }
                    setTimeout(() => Jt(x));
                  }
                }),
