...
const validSeo = {
  ...
  canonicalUrl: 'https://spesialis.id/services/cuci-ac-standar',
  robots: 'index, follow',
  ogTitle: 'Cuci AC Standar - Spesialis',
  ogDescription: 'Layanan cuci AC standar dengan harga terjangkau',
  ogImage: 'https://spesialis.id/images/cuci-ac.jpg',
  twitterTitle: 'Cuci AC Standar - Spesialis',
  twitterDescription: 'Layanan cuci AC standar dengan harga terjangkau',
  twitterImage: 'https://spesialis.id/images/cuci-ac.jpg',
