...
| `service-seo-schema.spec.ts` | 8     | HowTo schema JSON-LD verification + Related Services internal linking cards                                            |

**Total: ~156+ E2E tests across 18 spec files**
...
| SEOE2E-23 | Pillar Content Checkbox di Editor   | P1       | 🟡     | TBD (manual / via ArticleEditor save verification)                              |
| SEOE2E-24 | Sitemap Priority Boost untuk Pillar | P1       | 🟡     | TBD (sitemap XML parsing)                                                       |
| SEOE2E-25 | CollectionPage JSON-LD Auto-inject  | P1       | 🟡     | TBD (SSR blog page JSON-LD verification)                                        |
| SEOE2E-26 | Link Suggestion Engine              | P1       | 🟡     | TBD (API endpoint assertion)                                                    |
| SEOE2E-27 | SEO Score API                       | P1       | 🟡     | TBD (API endpoint assertion)                                                    |
| SEOE2E-28 | Cluster Visualizer Dashboard        | P1       | 🟡     | TBD (page load + component rendering)                                           |
...
- **SEOE2E-23 to SEOE2E-28** (Pillar Content): Seluruh 6 flow adalah 🟡 Partial — API endpoints dan UI components sudah diimplementasi di Sprint 1-5, namun dedicated E2E spec file `pillar-content.spec.ts` belum dibuat.
...
- **SEO E2E tests**: 35 (19 existing SEO + 8 service-faq + 8 service-seo-schema)
- **Pillar Content E2E tests**: 6 (SEOE2E-23 to SEOE2E-28 — TBD)
- **P0 coverage**: 100%
- **P1 coverage**: 64% (14/22 fully covered, 8/22 partially)
- **Overall coverage**: 77% (27/35 fully covered, 8/35 partially)
