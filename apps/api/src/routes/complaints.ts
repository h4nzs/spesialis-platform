...
import { createComplaintSchema, resolveComplaintSchema } from '@ahlipanggilan/validation';
import type { CreateComplaintInput, ResolveComplaintInput } from '@ahlipanggilan/validation';
