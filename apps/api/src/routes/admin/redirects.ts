...
import { createRedirectSchema, updateRedirectSchema } from '@ahlipanggilan/validation';
import type { CreateRedirectInput, UpdateRedirectInput } from '@ahlipanggilan/validation';
