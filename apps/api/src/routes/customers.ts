...
import { updateCustomerSchema, updateCustomerStatusSchema } from '@specialist/validation';
import type { UpdateCustomerInput, UpdateCustomerStatusInput } from '@specialist/validation';
