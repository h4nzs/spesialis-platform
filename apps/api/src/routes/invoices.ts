...
import { createInvoiceSchema, updateInvoiceStatusSchema } from '@ahlipanggilan/validation';
import type { CreateInvoiceInput, UpdateInvoiceStatusInput } from '@ahlipanggilan/validation';
